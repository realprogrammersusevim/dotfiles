...
Plug 'neoclide/coc.nvim', {'branch': 'release', 'for': ['python', 'vim', 'rust']}
Plug 'sonph/onehalf', { 'rtp': 'vim' }  " My theme
Plug 'preservim/nerdtree', { 'on': 'NERDTree' }  " File browser and manager
Plug 'Xuyuanp/nerdtree-git-plugin', {'on': 'NERDTree'}  " Show git changes in the Nerdtree
...
Plug 'soywod/himalaya', {'rtp': 'vim', 'on': 'Himalaya'}  " Email client
Plug 'mileszs/ack.vim', {'on': 'Ack'}  " Search for things in files
Plug 'nvim-treesitter/nvim-treesitter', {'do': ':TSUpdate'}	" Syntax highlighting
Plug 'nvim-lua/plenary.nvim'  " Not sure what this does, but it's a requirement for telescope
Plug 'nvim-telescope/telescope.nvim'  " A file explorer
Plug 'rcarriga/nvim-notify'  " Awesome GUI notifications
if has('nvim')
...
Plug 'ryanoasis/vim-devicons'  " Icons and glyphs
Plug 'ajmwagar/vim-deus'  " Deus colorscheme
Plug 'arcticicestudio/nord-vim'  " Nord colorscheme
Plug 'vlime/vlime',  {'rtp': 'vim'}  " Lisp coding
Plug 'nvim-orgmode/orgmode', {'rtp': 'vim'}  " Orgmode from Emacs
